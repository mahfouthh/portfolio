module.exports = [
  {
    ...
    title: (
      <>
        Bubble.io Web & Mobile Apps
      </>
    ),
    popupImg: "img/service/bubbleio.png",
    popupTitle: `Empowering Solutions: Web and Mobile Applications Developed with Bubble.io`,
    ...
    serviceListDescriptions: (
      <>
        <h3>What Is Bubble.io?</h3>
        <p>
          Bubble.io is a no-code platform for building web and mobile apps. It allows users to create applications using a visual interface, eliminating the need for traditional coding. The platform offers extensive customization options, integrations, and hosting services, making it accessible to a wide range of users without extensive technical expertise.
        </p>
      </>
    ),
  },
  {
    ...
    popupImg: "img/service/FullStack.png",
    popupTitle: `Full stack web development`,
    firstDescriptionText: (
      <>
        <p>
          I possess extensive proficiency in full-stack web development, adept at utilizing a diverse set of frameworks and languages to craft robust applications. My expertise spans across languages such as Node.js and Python, providing a solid foundation for backend development. Additionally, I excel in leveraging frameworks like Next.js, React, Vue, and Express to create dynamic and interactive user interfaces. On the backend, I am skilled in utilizing Python-based frameworks such as Django and Flask to develop scalable and efficient server-side components. This comprehensive skill set empowers me to design, build, and deploy full-stack web applications that seamlessly integrate front-end and back-end functionalities for optimal user experiences.
        </p>
      </>
    ),
    serviceListDescriptions: (
      <>
        ...
        <p><h5>Full Stack Web Development Process:</h5></p>
        <div className="in_list">
          <ol>
            ...
            <li>Deploy the application, making it accessible to users on the web.</li>
          </ol>
        </div>
      </>
    ),
  },
  {
    ...
    popupImg: "img/service/ai-and-dev.jpg",
  ...
  },
  {
    ...
    popupImg: "img/service/mobile-app-dev.jpeg",
    popupTitle: `Mobile App Design is the trending Part of Graphics`,
    firstDescriptionText: (
      <>
        <p>My expertise lies in mobile app development, with a focus on utilizing React Native to create cross-platform applications. I am proficient in handling the entire development cycle, from conceptualization to design, coding, testing, and deployment. This includes the seamless deployment of apps to both the App Store and Google Play Store, ensuring maximum accessibility for users across platforms.</p>
      </>
    ),
